    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
       <el-tabs type="card" >
        ...
        <el-form-item label="原因" prop="checkReason" v-if="form.checkStatus == '2'">
        ...
        <el-form-item label="完成时间" prop="finishTime" v-if="form.checkStatus == '1'">
...
<script>
import { listPurchase, getPurchase, delPurchase, addPurchase, checkPurchase, exportPurchase } from "@/api/asset/purchase";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            checkPurchase(this.form).then(response => {
