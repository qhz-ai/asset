...
<script>
import { listMyMaintain, getMaintain, delMaintain, addMaintain, updateMaintain, exportMaintain } from "@/api/asset/maintain";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMyMaintain(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
