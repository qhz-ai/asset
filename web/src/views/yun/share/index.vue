<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="发起人" prop="fromUserId">
        <el-input
    ...
    <el-table v-loading="loading" :data="shareList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="自增长主键ID" align="center" prop="id" />
      <el-table-column label="目录" align="center" prop="folderId" />
      <el-table-column label="文件" align="center" prop="fileId" />
      <el-table-column label="发起人" align="center" prop="fromUserId" />
      <el-table-column label="接收人" align="center" prop="toUserId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="发起人" prop="fromUserId">
          <el-input v-model="form.fromUserId" placeholder="请输入发起人" />
        </el-form-item>
        <el-form-item label="接收人" prop="toUserId">
          <el-input v-model="form.toUserId" placeholder="请输入接收人" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除云盘共享编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有云盘共享数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
