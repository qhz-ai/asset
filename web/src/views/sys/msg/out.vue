  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="接收人" prop="users" v-if="form.type != '2'">
          <el-select v-model="form.users" filterable multiple placeholder="请输入姓名选择" :loading="loading">
            <el-option
...
<script>
import { outMsg, getMsg, delMsg, addMsg, updateMsg, exportMsg } from "@/api/sys/msg";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      outMsg(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
